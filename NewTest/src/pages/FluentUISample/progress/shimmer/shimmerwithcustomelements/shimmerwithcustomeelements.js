...
const ShimmerCustomElementsExample: React.FunctionComponent = () => (
  <>
  <div className="fluenttitle divpadt10">Shimmer with custom elements using the ~customElementsGroup~ prop</div>
