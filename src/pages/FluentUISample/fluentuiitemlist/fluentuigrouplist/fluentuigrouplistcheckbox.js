...
export const FluentUIGroupedListCustomCheckbox: React.FunctionComponent = () => {
    ...
    return (
        <div className="ms-Grid-row" >
            <div className="ms-Grid-col ms-lg12 ">
                <div className="fluenttitle divpadt10">GroupedList example with custom checkbox</div>
