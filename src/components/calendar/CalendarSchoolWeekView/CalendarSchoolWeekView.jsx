...
class CalendarSchoolWeekView extends Component{   
  constructor(props){    
    super(props);
    this.state = {
      today : new Date()
  ...
  render(){
    ...
    return (  
        <div className="calendarSchoolWeekView">         
          <FullCalendar
...
function renderEventContent(eventInfo) {    
    ...
    return (    
      <div className="schoolWeekViewSchedule">         
      { eventInfo.event.groupId === "classSchedule"
      ?      
      a < b ? (<FontIcon iconName="CompletedSolid"  className="schoolWeekCompleteIcon"/>) : (<FontIcon iconName="SkypeCircleClock"  style={calendarIcon}/>)      
      : null }  
