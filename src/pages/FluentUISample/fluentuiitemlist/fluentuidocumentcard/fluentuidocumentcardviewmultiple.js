...
const FluentUIDocumentCardCompleteViewMultiple: React.FunctionComponent = () => {
    return (
        <div className="ms-Grid-row" >
            <div className="ms-Grid-col ms-lg12 ">
                <div className="fluenttitle divpadt10">DocumentCard with multiple items, commands, and views</div>
