...
const FluentUIDocumentCardConversationLogo: React.FunctionComponent = () => {
    ...
    return (
        <div className="ms-Grid-row" >
            <div className="ms-Grid-col ms-lg12 ">
                <div className="fluenttitle divpadt10">Conversation cards with logo, text preview, and status</div>
