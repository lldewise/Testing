...
const groups: IGroup[] = createGroups(4, 0, 0, 5);
 ...
 const FluentUIGroupedListCustomExample: React.FunctionComponent = () => {
    return (
        <div className="ms-Grid-row" >
            <div className="ms-Grid-col ms-lg12 ">
                <div className="fluenttitle divpadt10">GroupedList example with custom header and footer</div>
